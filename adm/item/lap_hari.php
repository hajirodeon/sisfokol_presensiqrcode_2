...
if ((empty($utgl)) OR (empty($ubln)))
	...
	if ($count != 0)
		...
		do 
			...
			//detail item
			$qmboh = mysqli_query($koneksi, "SELECT * FROM m_item ".
									"WHERE kd = '$i_item_kd'");
			...
			//detail orang
			$qmboh2 = mysqli_query($koneksi, "SELECT * FROM m_orang ".
									"WHERE kd = '$i_orang_kd'");
			...
			//update
			mysqli_query($koneksi, "UPDATE item_pinjam SET item_qrcode = '$i_item_qrcode', ".
			...
			//masukin ke rekap
			mysqli_query($koneksi, "INSERT INTO item_rekap(kd, item_kd, item_kode, item_nama, ".
			...
			mysqli_query($koneksi, "UPDATE m_item SET pinjam_nama = '$pinjam_nama', ".
