...
if ($_POST['btnEXPORT'])
	...
	do
		...
		$qyuk = mysqli_query($koneksi, "SELECT * FROM orang_presensi ".
...
if ($s == "hapusmasuk")
	{	
	//hapus
	mysqli_query($koneksi, "DELETE FROM orang_presensi ".
					"WHERE kd = '$lokd'");
...
if ((empty($utgl)) OR (empty($ubln)))
	...
	if ($count != 0)
		...
		do 
			...
			//masukin ke rekap
			mysqli_query($koneksi, "INSERT INTO orang_rekap(kd, orang_kd, orang_kode, orang_nama, ".
